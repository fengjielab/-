...
// ESP32 UART2，连接 STM32 USART1。
HardwareSerial Stm32Serial(2);

// ESP32 UART2 引脚，可按开发板实际接线修改。
static constexpr int STM32_RX_PIN = 16;  // ESP32 RX2 <- STM32 PA9(TX)，可选
static constexpr int STM32_TX_PIN = 17;  // ESP32 TX2 -> STM32 PA10(RX)
...
void loop() {
  ...
  // 把 STM32 的启动提示丢弃，避免它回到 Nano 串口造成干扰。
